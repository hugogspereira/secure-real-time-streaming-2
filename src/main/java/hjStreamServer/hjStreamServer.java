	...
	static public void main( String []args ) throws Exception {
		if (args.length != 6) {
			   /*
				...
				2	236.16.20.30
				3	9999
				4	src/main/java/hjStreamServer/stream-cryptoconfig.txt -> no need
				5	omsqptaesdfommptvsnfiocmlesrfoqppms
				*/
		...
		DataInputStream g = s.decryptMovie(args[1], args[5]);     // <movies-config> <password>
